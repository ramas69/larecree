...
final class CheckoutController extends AbstractController
{
    ...
    public function start(string $slug, Request $request, FormationRepository $formations, StripeCheckoutService $checkout): RedirectResponse
    {
        ...
        $plan = $request->query->get('plan') === '3x' ? '3x' : 'once';
        $session = $checkout->createSession($formation, $plan);
